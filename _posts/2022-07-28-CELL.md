...
### NR
    ...
    int   nr_tac  // 0..16777215 Tracking Area Code 追踪区域码
...
### GSM | TDSCDMA | WCDMA
    ...
    int   rxlev  // Received Signal Level (GSM|TDSCDMA|WCDMA) 接收信号电平 
                 //      GSM: RSSI -113..-51 dBm Received Signal Strength Indicator 接收信号强度指示
                 // TD|WCDMA: RSCP -120..-24 dBm Received Signal Code Power 接收信号码功率
